...
function inputPDIcon() {
    ...
    for(let item of elems){
        ...
        //create Logo by IMG from icons8
/*         var newItem = document.createElement("img");
        ...
        item.parentNode.appendChild(newItemSVG);
    }
}

function warning(){
    document.getElementsByClassName("appendedSecurityLogo")[0].setAttribute('id', 'warningSecurityLogo');
}

function safe(){
    document.getElementsByClassName("appendedSecurityLogo")[0].setAttribute('id', 'safeSecurityLogo');
}
